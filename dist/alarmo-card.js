...
`}render(){return this._params?N`
    ...
    `:N``}_ignoreKeydown(t){t.stopPropagation()}_cancel(t){t&&t.stopPropagation(),this.closeDialog()}_save(t){var e;t&&t.stopPropagation(),null===(e=this._params)||void 0===e||e.confirm(this._params.config),this.closeDialog()}_updateConfig(t){this._params&&(this._params=Object.assign(Object.assign({},this._params),{config:Object.assign(Object.assign({},this._params.config),t)}))}static get styles(){return o`
      ...
      `}};e([et({attribute:!1})],ae.prototype,"hass",void 0),e([it()],ae.prototype,"_params",void 0),ae=e([Q("alarmo-action-config-dialog")],ae);var re=Object.freeze({__proto__:null,get AlarmoActionConfigDialog(){return ae}});const ne=t=>t.callWS({type:"alarmo/entities"}),oe=t=>t.callWS({type:"alarmo/config"});let le=class extends X{constructor(){super(...arguments),this._entities=[]}async firstUpdated(){ne(this.hass).then(t=>{this._entities=t.map(t=>t.entity_id)}).catch(t=>{}),this._alarmoConfig=await oe(this.hass)}setConfig(t){this._config=Object.assign({},t)}render(){var t,e,i;if(!this._config||!this.hass)return N``;if(!this._entities.length)return N`
        <hui-warning>
    ...
    ${[...ie(s),Rt.Disarm].map(t=>{const e=ie(s).map(t=>Yt[t]),i=ee(Yt[t],this._config).hide;return N`
      ...
      `})}
        ...
        <ha-formfield
          .label=${Xt("editor.keep_keypad_visible",this.hass.language)}
        >
          <ha-switch
        ...
        ></ha-formfield>`:""}
        <ha-formfield
          .label=${Xt("editor.button_scale",this.hass.language)}
        >
          <ha-slider
        ...
        <ha-formfield
          .label=${Xt("editor.use_clear_icon",this.hass.language)}
        >
          <ha-switch
      ...
      `:""}
        ...
        <ha-formfield
          .label=${Xt("editor.show_messages",this.hass.language)}
        >
          <ha-switch
    ...
    `}static get styles(){return o`
      ...
      `}}e([et()],he.prototype,"hass",void 0),e([et()],he.prototype,"entity",void 0),e([et()],he.prototype,"state",void 0),customElements.define("alarmo-sensor-badge",he);class ue extends X{constructor(){super(...arguments),this.disabled=!1,this.scaled=!1}render(){return N`
      ${this.scaled?N`
      <button
      ...
      <ha-card>
        ...
        ${Ut.map(t=>""===t?N` 
              ...
              <alarmo-button
                ...
                ?scaled=${1!=this._config.button_scale}
              >
                ${"clear"===t?this._config.use_clear_icon?N`<ha-icon icon="hass:backspace-outline"></ha-icon>`:this.hass.localize("ui.card.alarm_control_panel.clear_code"):t}
              </alarmo-button>
            `)}
          </div>
      `}
    ...
    `:N`
      ...
      `}_renderActions(){if(!this.hass||!this._config)return N``;const t=this.hass.states[this._config.entity];return(t.state===jt.Disarmed?ie(t).filter(t=>!ee(Yt[t],this._config).hide):[Rt.Disarm]).map(t=>{const e=ee(Yt[t],this._config);return N`
        ...
        ${"blocking_sensors"==this.warning?Xt("errors.blocking_sensors",this.hass.language):Xt("errors.triggered_sensors",this.hass.language)}
          ...
          <div class="content">
            ${Object.entries(t.attributes.open_sensors).map(([t])=>(this.subscribedEntities.includes(t)||this.subscribedEntities.push(t),N`
            <div class="badge">
              <alarmo-sensor-badge
                .hass=${this.hass}
                .entity=${t}
    ...
    `}},e([et({attribute:!1})],t.AlarmoCard.prototype,"hass",void 0),e([it()],t.AlarmoCard.prototype,"_config",void 0),e([it()],t.AlarmoCard.prototype,"_alarmoConfig",void 0),e([it()],t.AlarmoCard.prototype,"_input",void 0),e([it()],t.AlarmoCard.prototype,"warning",void 0),e([it()],t.AlarmoCard.prototype,"area_id",void 0),t.AlarmoCard=e([Q("alarmo-card")],t.AlarmoCard),window.customCards=window.customCards||[],window.customCards.push({type:"alarmo-card",name:"Alarmo Card",description:"Card for operating Alarmo through Lovelace."}),console.info("%c  ALARMO-CARD  \n%c  Version: "+"v1.2.1".padEnd(7," "),"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray")}({});
