                      ...
                      `:N`
                        ...
                        >
                          ${"clear"===t?this._config.use_clear_icon?N`
                                ...
                                `:this.hass.localize("ui.card.alarm_control_panel.clear_code"):t}
                        </alarmo-button>
                      `)}
              </div>
            `}
          ...
          <div class="messagebox-inner">
            ...
            <div class="content">
              ${Object.entries(t.attributes.open_sensors).map(([t])=>(this.subscribedEntities.includes(t)||this.subscribedEntities.push(t),N`
                  <div class="badge">
                    <alarmo-sensor-badge .hass=${this.hass} .entity=${t}> </alarmo-sensor-badge>
                  </div>
                `))}
            </div>
          </div>
